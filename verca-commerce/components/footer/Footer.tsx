...
async function Footer() {
  ...
  return (
    <footer className='footer bg-base-100 text-base-content p-10  bottom-0'>
      <aside>
        <svg
          width='50'
          height='50'
      ...
      <nav>
        <h1 className='footer-title text-white'>{t('contact')}</h1>
      ...
      <nav>
        ...
        <p>{siteConfig.address.streetNumber}</p>
      </nav>
      <nav>
